...
//////////////////////////////
//
// EventBuffer::check -- look at each element in the 
// 	buffer to see if they need to be executed.
//

void EventBuffer::check(void) {
   check((long)timer.getTime());
}


void EventBuffer::check(long currentTime) {
...
// md5sum:        11e036d1f9b609ff0acf3950d5508534  EventBuffer.cpp
