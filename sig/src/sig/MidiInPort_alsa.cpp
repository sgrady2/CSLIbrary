...
// Last Modified: Sun May 14 22:03:20 PDT 2000
      ...
      if (packet[0] & 0x80) {   // a command byte has arrived
         ...
         if (argsExpected[device] >= 0 && !argsLeft[device]) {
            ...
            switch (message[device].p0() & 0xf0) {
               ...
               case 0xa0:      argsLeft[device] = 1;      break;
...
// md5sum:	c8e78652a995d9eca69eb1c9bedd2d60  MidiInPort_alsa.cpp
