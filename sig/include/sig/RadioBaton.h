...
#include "batonprotocol.h"       /* December 1997 communication protocol   */
...
class RadioBaton : public MidiIO {
   ...
   // public state variables
      ...
      short calib[22];         // calibration data;
      char* calibFilename;     // the name of the file to write calib data
      int   writingCalib;      // set to true if writing calibration data
...
// md5sum:        28512a6e7c0b7e69a0ded5819ea28d5e  RadioBaton.h
