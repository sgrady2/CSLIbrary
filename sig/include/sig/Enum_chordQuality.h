...
// Filename:      ...humdrum++/include/Enum_ChordQuality.h
// Syntax:        C++ 
//
...
// tetrads
#define E_chord_fullydim       (108)       /* example:   C Eb Gb Bbb         */
#define E_chord_halfdim        (109)       /* example:   C Eb Gb Bb          */
#define E_chord_minmin         (110)       /* example:   C Eb G  Bb          */
#define E_chord_minmaj         (111)       /* example:   C Eb G  B           */
#define E_chord_domsev         (112)       /* example:   C E  G  Bb          */
#define E_chord_majmaj         (113)       /* example:   C E  G  B           */

// special chords
#define E_chord_frensix        (114)       /* example:   Ab C D  F#          */
#define E_chord_germsix        (115)       /* example:   Ab C Eb F#          */
#define E_chord_italsix        (116)       /* example:   Ab C    F#          */
...
// md5sum:	ab4271928a5dba82c415ad04f88a7492  Enum_chordQuality.h
